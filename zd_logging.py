...
handler2 = logging.handlers.RotatingFileHandler("./log/zen_data_" + time.strftime("%m%d%H%M", time.localtime()) + ".log", mode="a", maxBytes=1024*1024, backupCount=0, encoding="utf-8")
